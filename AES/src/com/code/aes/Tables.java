...
/**
 * Classe contenente le loop-up tables indispensabili per l'AES.
 * @author Davide Violante
 *
 */
public class Tables {
	
	/* S-Box e inverted S-Box su cui si basa l'AES.
	 * http://en.wikipedia.org/wiki/Rijndael_S-box
	 */
	public final int[] Sbox = { 0x63, 0x7C, 0x77, 0x7B, 0xF2, 0x6B,
	...
	public final int[] invertedSbox = {  };

	/* S-box utilizzata per generare le sub-keys
	 * http://en.wikipedia.org/wiki/Rijndael_key_schedule#Rcon
	 */
	public final int Rcon[] = { 0x8d, 0x01, 0x02, 0x04, 0x08, 0x10,
